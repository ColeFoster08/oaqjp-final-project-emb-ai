...
def emot_detector():
    ''' This code receives the text from the HTML interface and 
        runs emotion detection over it using a emotion_detector()
        function. The output returned shows the confidence scores 
        for various emotions as well as the dominant emotion that
        it detected from the text.
    '''
